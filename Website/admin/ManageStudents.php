...
if(empty($Username=$_POST["Username"]))
{
	...
	Redirect_to("ManageStudents.php");	
}
elseif(!empty($Usernameavailable))
{
 $_SESSION["ErrorMessage"]="USN already exist.";
 Redirect_to("ManageStudents.php");	
}
else
{
 $db->query("INSERT INTO students (email, password) VALUES(:email, :password)");
 ...
 if($db->lastInsertId())
{
	...
	$_SESSION["SuccessMessage"]="Student added sussessfully.";
	Redirect_to("ManageStudents.php");
}
 else
 {
...
<tr>
	...
	<td align="center"><a href="DeleteStudent.php?id=<?php echo $row['id'];?>">
